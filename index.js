...
function init() {
  inquirer.prompt(openingQuest).then(function (answers) {
...
function addDept() {
  inquirer.prompt(newdDept).then((answers) => {
    db.query(
      ...
      .then((answers) => {
        db.query(
          `INSERT into role(title, salary, department_id)
            VALUES("${answers.newRole}","${answers.newRoleSalary}","${answers.newRoleDept}");`,
          function (err, results) {
      ...
      inquirer
        ...
        .then((answers) => {
          db.query(
            ...
            VALUES("${answers.firstname}","${answers.lastname}","${answers.empRole}", "${answers.empMan}");`,
            function (err, results) {
              console.log("Succesfully Updated");
